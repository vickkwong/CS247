...
(function () {
  ...
  function connect_to_chat_firebase() {
    fb_instance = new Firebase("https://luminous-fire-3782.firebaseIO.com");
    ...
    fb_instance_stream.on('child_removed', function (snapshot) {
      display_user({
        m: snapshot.val().name + " has left the room",
        c: snapshot.val().c
      });
    });
  ...
  function display_user(usr) {
    $("#user_history").append("<div class='msg' style='color:" + usr.c + "'>" + usr.m + "</div>");
  }
